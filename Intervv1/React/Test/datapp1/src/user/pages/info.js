...
import MCLogo from "../pages/logos/MCLogoV1.png";
        ...
        <Container className="container">
          ...
          >
            <div className="col-xl-6 col-lg-8 text-dark">
              ...
              <h2>The information was graphed with Recharts</h2>
            </div>
          </Row>
                ...
                <Col className="col-md-7">
                  ...
                  >
                    ...
                    <p>
                      ...
                      Recharts. Which is an easy-to-use library in
                      react, the only variations to Stacked, Scatter,
                      & Area were done to
                  ...
                  >
                    ...
                    <p>
                      ...
                      that can be copied on React or React.js on the corresponding
                      sections of the file. In this case, the information was
                      pasted onto a .js file in React.js which is accessed by the
